<?php
class ControllerBlogVideoarticle extends Controller
{
	public function index()
	{
		$this->load->language('blog/video_article');
		...
		$article_info = $this->model_blog_video->getArticle($video_id);
		...
		if ($article_info)
		{
			...
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('blog/video_article', '&video_id=' . $this->request->get['video_id'])
			);

			//$this->document->setTitle($article_info['meta_title']);
			//$this->document->setDescription($article_info['meta_description']);
			//$this->document->setKeywords($article_info['meta_keyword']);
			//$this->document->addLink($this->url->link('blog/article', 'video_id=' . $this->request->get['video_id']), 'canonical');
			...
			$this->response->setOutput($this->load->view('blog/video_article.tpl', $data));
		} else {
			$url = '';
			...
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('blog/video_article', $url . '&video_id=' . $video_id)
			);
