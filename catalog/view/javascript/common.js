...
function stickyMenu(){
  ...
  $(".home1 .hozmenu-container").toggleClass("fix-header", s0w991);
  $(".home3 .hozmenu-container").toggleClass("fix-header", s0w991);
  $(".home4 .hozmenu-container").toggleClass("fix-header", s0w991);
  $(".home2 header").toggleClass("fix-header", s0w991);
}
stickyMenu();
