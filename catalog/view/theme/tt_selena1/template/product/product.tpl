        ...
        <div class="col-2 col-sm-7">
		  ...
		  <p class="short-des">
			  ...
			  <div class="form-group">
				...
				<button class="button btn-wishlist" type="button" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>');"><i class="ion-ios-heart-outline"></i><span><?php echo $button_wishlist; ?></span></button>
				<button class="button btn-compare" type="button" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>');"><i class="ion-podium"></i><span><?php echo $button_compare; ?></span></button>
			</div>
				  ...
				  <?php if ($product['price']) { ?>
					...
					<div class="product-intro">	
						<div class="actions-link2">
							...
							<a class="btn-cart" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="icon ion-bag"></i><!-- <?php //echo $button_cart; ?> --></a>
