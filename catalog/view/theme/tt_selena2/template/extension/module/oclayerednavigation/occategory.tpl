...
<div class="container layer-category">
    ...
    <div class="row"><?php echo $column_left; ?>
        ...
        <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
			...
			<?php if ($categories) { ?>
      <h3 class="page-heading"><?php echo $text_refine; ?></h3>
                            ...
                            <div class="product-inner">
                              ...
                              <div class="product-intro">
								<div class="actions-link2">
									<a class="btn-wishlist" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="ion-ios-heart-outline"></i><!-- <span><?php //echo $button_wishlist; ?></span> --></a>
									<a class="btn-cart" data-toggle="tooltip" title="<?php echo $button_cart; ?>" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="icon ion-bag"></i><span class="button"><?php echo $button_cart; ?></span></a>
									<a class="btn-compare" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="ion-podium"></i><!-- <span><?php //echo $button_compare; ?></span> --></a>
								</div>
							</div>
                            </div>
							</div>
